...
ditto -c -k --sequesterRsrc --keepParent "$APP" "$DIST/LeoMiniGames-v${VERSION}-iOS-simulator-${SUFFIX}-unsigned.zip"
echo 'No device IPA/App Store artifact is claimed without Apple signing credentials.'
